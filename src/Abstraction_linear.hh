...
template<class F2, class F3, class F4=decltype(params::avoid_abs)>
  ...
  */
   ...
   if (!mark) {
     write_to_filebb(m_state_alphabet,m_input_alphabet,recomputed_mark,"recomputation_1");
   }
   else
   {
     write_to_filebb(m_state_alphabet,m_input_alphabet,recomputed_mark,"recomputation_2");
   }
